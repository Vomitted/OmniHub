...
| [Interface, version 5](TECHNICAL-v5-ui.md) | The console: each page's subject above the fold, every reading with its history, the sidebar as an index of what is in force; then drawn — rings, meters, tiles and four history charts on one clock, the live theme switch fixed (sections 7–8) |
